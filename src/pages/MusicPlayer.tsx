          ...
          <Card className="bg-gray-800/95 shadow-lg rounded-xl border border-gray-700 mb-8">
            <CardHeader className="pb-2">
              <div className="flex items-center">
                ...
                <CardTitle className="text-xl font-semibold text-gray-200">{t("player.details")}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="p-4 rounded-lg border border-gray-700 bg-red-800">
                  <div className="flex items-center mb-2">
                    ...
                    <p className="text-sm text-gray-400">{t("player.duration")}</p>
                  </div>
                  <p className="text-gray-200 font-medium">{t("player.preview_duration")}</p>
                </div>
                ...
                <div className="bg-gray-900/90 p-4 rounded-lg border border-gray-700">
                  ...
                  <p className="text-gray-200 font-medium">{t("player.preview_format")}</p>
                </div>
              </div>
              
              <div className="bg-gray-900/90 p-4 rounded-lg border border-gray-700">
                <h3 className="text-lg font-medium text-gray-200 mb-3">{t("player.instructions")}</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-300">
                  <li>{t("player.instruction1")}</li>
                  <li>{t("player.instruction2")}</li>
                  <li>{t("player.instruction3")}</li>
                  <li>{t("player.instruction4")}</li>
                </ul>
              </div>
            </CardContent>
          </Card>
