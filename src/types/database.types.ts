...
export type MusicRequest = {
  ...
  music_tone?: 'happy' | 'romantic' | 'nostalgic' | 'fun' | 'melancholic' | 'energetic' | 'peaceful' | 'inspirational';
  voice_type?: 'male' | 'female' | 'male_romantic' | 'female_romantic' | 'male_folk' | 'female_folk' | 'male_deep' | 'female_powerful' | 'male_soft' | 'female_sweet';
